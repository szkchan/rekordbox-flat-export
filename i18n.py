...
STRINGS: dict[str, dict[str, str]] = {
    "ja": {
        ...
        "col_count": "曲数",
        "tab_playlist_mode": "プレイリストモード",
        "tab_bpm_mode": "BPM検索モード",
        "label_bpm_target": "目標BPM:",
        "label_bpm_tolerance": "許容範囲 (±):",
        "btn_bpm_search": "検索",
        "label_bpm_folder": "出力フォルダ名:",
        "col_title": "曲名",
        "col_artist": "アーティスト",
        "col_bpm": "BPM",
        "msg_bpm_invalid": "目標BPMと許容範囲には数値を入力してください。",
        "msg_bpm_folder_missing": "出力フォルダ名を入力してください。",
        "log_bpm_found": "BPM {target} ± {tol} で {n} 曲見つかりました。",
        ...
        "msg_not_loaded": "先にライブラリを読み込んでください。",
        "msg_no_selection": "コピーする項目を1つ以上選択してください。",
    ...
    "en": {
        ...
        "browse": "Browse...",
        "btn_load": "Load library",
        "btn_select_all": "Select all",
        "btn_deselect_all": "Deselect all",
        "col_sel": "Copy",
        "col_name": "Playlist name (output folder)",
        "col_count": "Tracks",
        "tab_playlist_mode": "Playlist mode",
        "tab_bpm_mode": "BPM search mode",
        "label_bpm_target": "Target BPM:",
        "label_bpm_tolerance": "Tolerance (±):",
        "btn_bpm_search": "Search",
        "label_bpm_folder": "Output folder name:",
        "col_title": "Title",
        "col_artist": "Artist",
        "col_bpm": "BPM",
        "msg_bpm_invalid": "Please enter valid numbers for target BPM and tolerance.",
        "msg_bpm_folder_missing": "Please enter an output folder name.",
        "log_bpm_found": "Found {n} track(s) for BPM {target} ± {tol}.",
        ...
        "msg_not_loaded": "Please load the library first.",
        "msg_no_selection": "Please select at least one item to copy.",
